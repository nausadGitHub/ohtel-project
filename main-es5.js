...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppDetailsDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function DetailsComponent_section_12_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("\xA0 ", ctx_r104.spacesDetailsData.locationName, "");
  ...
  function srcAppNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function NavbarComponent_header_0_option_20_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var language_r122 = ctx.$implicit;
    ...
    function NavbarComponent_header_0_option_31_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var language_r123 = ctx.$implicit;
    ...
    function NavbarComponent_header_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function NavbarComponent_header_0_Template_select_change_13_listener($event) {
          ...
          return ctx_r124.onChange($event.target.value);
        });
    ...
    function NavbarComponent_ng_template_1_option_20_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var language_r130 = ctx.$implicit;
    ...
    function NavbarComponent_ng_template_1_option_53_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var language_r131 = ctx.$implicit;
    ...
    function NavbarComponent_ng_template_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function NavbarComponent_ng_template_1_Template_select_change_13_listener($event) {
          ...
          return ctx_r132.onChange($event.target.value);
        });
      ...
      template: function NavbarComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function NavbarComponent_Template_form_ngSubmit_19_listener() {
            ...
            var _r110 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](20);

            return ctx.signInFunction(_r110);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function NavbarComponent_Template_form_ngSubmit_53_listener() {
            ...
            return ctx.signUpFunction(_r110);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function NavbarComponent_Template_form_ngSubmit_94_listener() {
            ...
            return ctx.forgetPassword(_r110);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function NavbarComponent_Template_form_ngSubmit_141_listener() {
            ...
            return ctx.resetPassword(_r110);
          });
  ...
  function srcAppPostAdsPostAdsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PostAdsComponent = /*#__PURE__*/function () {
      function PostAdsComponent(homeService) {
    ...
    PostAdsComponent.ɵfac = function PostAdsComponent_Factory(t) {
      return new (t || PostAdsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_home_service__WEBPACK_IMPORTED_MODULE_1__["HomeService"]));
    };
    ...
    PostAdsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function PostAdsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](167, "\xA0");
    ...
    PostFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function PostFormComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](117, "\xD7");
  ...
  function srcAppSharedCategorySharedCategoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SharedCategoryComponent_div_1_ul_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SharedCategoryComponent_div_1_ul_4_Template_li_click_1_listener() {
          ...
          return ctx_r144.setIndex(i_r143);
        });
      ...
      if (rf & 2) {
        var category_r142 = ctx.$implicit;
        var i_r143 = ctx.index;
    ...
    var SharedCategoryComponent = /*#__PURE__*/function () {
      function SharedCategoryComponent(homeService, toastr) {
        ...
        this.getCategoriesLists = function () {
          return _this22.homeService.getCategoryList().subscribe(function (response) {
            // this.getDeals();
            _this22.categoryLists = response[0].data; // sort by value

            _this22.categoryLists.sort(function (a, b) {
              return a.categoryID - b.categoryID;
            });

            console.log(response);
            console.log(_this22.categoryLists);
          }, function (error) {
            _this22.toastr.errorToastr('Some error occured ' + error);
          });
        };
      }
  ...
  function srcAppSpacesListSpacesListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SpacesListComponent = /*#__PURE__*/function () {
      function SpacesListComponent(route, activatedRoute, homeService) {
        ...
        this.viewPostMethod = function () {
          if (_this24.userId === null || _this24.userId === undefined || _this24.userId === '') {
            var data = {
              userID: '',
              categoryID: _this24.categoryID,
              subcategoryID: _this24.subCategoryId,
              cityID: _this24.cityID
            };
            console.log("user not present data ".concat(JSON.stringify(data)));

            _this24.homeService.viewPost(data).subscribe(function (response) {
              if (response[0].status === 'true') {
                _this24.viewPost = response[0].data;

                _this24.slicePostType();

                console.log(_this24.viewPost);
              } else {
                _this24.viewPost = []; // this.emptyData = response[0];
            ...
            _this24.homeService.viewPost(_data4).subscribe(function (response) {
              if (response[0].status === 'true') {
                _this24.viewPost = response[0].data;
        ...
        this.slicePostType = function () {
          if (_this24.viewPost.length === 0) {
            _this24.seller = _this24.viewPost;
            _this24.buyer = _this24.viewPost;
          } else {
            var _iterator7 = _createForOfIteratorHelper(_this24.viewPost),
                _step7;
            ...
            try {
              for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
                ...
                if (post.postType === 'Seller') {
                  _this24.seller.push(post);
                } else {
                  _this24.buyer.push(post);
                }
              }
            } catch (err) {
              _iterator7.e(err);
          ...
          var _iterator8 = _createForOfIteratorHelper(_this24.buyer),
              _step8;

          try {
            for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
              var buyers = _step8.value;
          ...
          console.log(_this24.seller);
          console.log(_this24.buyer);
        };
      }
      ...
      _createClass(SpacesListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.homeService.getSubCategoryList(this.categoryID).subscribe(function (response) {
            if (response[0].status === 'true') {
              _this25.spaceCategory = response[0].data; // sort by value

              _this25.spaceCategory.sort(function (a, b) {
                return a.subcatID - b.subcatID;
              });

              _this25.selectedIndex = 0;
              _this25.subCategoryId = _this25.spaceCategory[0].subcatID; //

              _this25.userId = ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_1__["Cookie"].get('userID');

              _this25.homeService.updatedID.subscribe(function (cityId) {
                _this25.cityID = cityId;

                _this25.viewPostMethod();
              }); // this.viewPostMethod();


              console.log(_this25.spaceCategory);
            }
          }); // end of sub category request call
        ...
        value: function getIndex(i) {
          ...
          var _iterator9 = _createForOfIteratorHelper(this.viewPost),
              _step9;
    ...
    var UpdateUserDataComponent = /*#__PURE__*/function () {
      function UpdateUserDataComponent(dialog, toastr, homeService, dialogBox, data) {
        ...
        this.updateUser = function (form) {
          if (!_this27.firstName) {
            _this27.toastr.warningToastr('Enter First Name.', 'Alert!');
          } else if (!_this27.lastName) {
            _this27.toastr.warningToastr('Enter Last Name.', 'Alert!');
          } else if (!_this27.contactNumber) {
            _this27.toastr.warningToastr('Enter mobile Number.', 'Alert!');
          } else if (!_this27.email) {
            _this27.toastr.warningToastr('Please enter email');
          } else {
            var userDate = {
              userID: _this27.data.userID,
              firstName: _this27.firstName,
              lastName: _this27.lastName,
              email: _this27.email,
              mobileNumber: _this27.contactNumber
            };
            console.log('data checking before posting it!', userDate);

            _this27.homeService.userUpdate(userDate).subscribe(function (response) {
              if (response[0].status === 'true') {
                _this27.updatedData = response[0].data;
                console.log('updated data', _this27.updatedData);

                _this27.toastr.successToastr('user updated Successfull.', 'Success!');
                ...
                setTimeout(function () {
                  _this27.updateClosebutton.nativeElement.click();

                  form.resetForm(); // or form.reset();

                  _this27.homeService.setInfoInLocalStorage(response[0].data);
                }, 2000);
              } else {
                _this27.toastr.errorToastr(response[0].message);
              }
            }, // tslint:disable-next-line:no-shadowed-variable
            function (error) {
              _this27.toastr.errorToastr('Some error occured' + error);
            });
          }
        };
      }
    ...
    var UsedEquipmentComponent = /*#__PURE__*/function () {
      function UsedEquipmentComponent(route, activatedRoute, homeService) {
        ...
        this.viewPostMethod = function () {
          if (_this28.userId === null || _this28.userId === undefined || _this28.userId === '') {
            ...
            _this28.homeService.viewPost(_data5).subscribe(function (response) {
              if (response[0].status === 'true') {
                _this28.viewPost = response[0].data;
        ...
        this.slicePostType = function () {
          if (_this28.viewPost.length === 0) {
            ...
            var _iterator10 = _createForOfIteratorHelper(_this28.viewPost),
                _step10;
          ...
          var _iterator11 = _createForOfIteratorHelper(_this28.buyer),
              _step11;

          try {
            for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
              var buyers = _step11.value;
      ...
      _createClass(UsedEquipmentComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.homeService.getSubCategoryList(this.categoryID).subscribe(function (response) {
            if (response[0].status === 'true') {
              _this29.usedEquipment = response[0].data; // sort by value

              _this29.usedEquipment.sort(function (a, b) {
                return a.subcatID - b.subcatID;
              });

              _this29.selectedIndex = 0;
              _this29.subCategoryId = _this29.usedEquipment[0].subcatID; //
              ...
              console.log(_this29.usedEquipment);
            }
          }); // end of sub category request call
